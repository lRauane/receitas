...
export function Detail() {
  ...
  useLayoutEffect(() => {
    async function getStatusFavorite() {
      const receipesFavorites = await isFavorite(route.params?.data);
      setFavorite(receipesFavorites);
    }
  ...
  async function handleFavoriteRecipe(receipe) {
    if (favorite) {
